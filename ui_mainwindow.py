...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionAmplitud_Profundidad = QAction(MainWindow)
        self.actionAmplitud_Profundidad.setObjectName(u"actionAmplitud_Profundidad")
        ...
        self.salida_grafo.setGeometry(QRect(10, 30, 171, 221))
        self.label_12 = QLabel(self.tab_3)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(10, 260, 61, 16))
        self.label_13 = QLabel(self.tab_3)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(10, 290, 61, 16))
        self.orig_x_spinBox = QSpinBox(self.tab_3)
        self.orig_x_spinBox.setObjectName(u"orig_x_spinBox")
        self.orig_x_spinBox.setGeometry(QRect(80, 260, 101, 22))
        ...
        self.orig_y_spinBox.setGeometry(QRect(80, 290, 101, 22))
        self.orig_y_spinBox.setMaximum(500)
        self.label_14 = QLabel(self.tab_3)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(10, 320, 61, 20))
        self.label_15 = QLabel(self.tab_3)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(10, 350, 61, 20))
        self.dest_x_spinBox = QSpinBox(self.tab_3)
        self.dest_x_spinBox.setObjectName(u"dest_x_spinBox")
        self.dest_x_spinBox.setGeometry(QRect(80, 320, 101, 22))
        self.dest_x_spinBox.setMaximum(500)
        self.dest_y_spinBox = QSpinBox(self.tab_3)
        self.dest_y_spinBox.setObjectName(u"dest_y_spinBox")
        self.dest_y_spinBox.setGeometry(QRect(80, 350, 101, 22))
        self.dest_y_spinBox.setMaximum(500)
        ...
        self.menuRecorridos.addAction(self.actionAmplitud_Profundidad)
        self.menuRecorridos.addAction(self.actionPrim)
        self.menuRecorridos.addAction(self.actionKruskal)
        self.menuRecorridos.addAction(self.actionDijkstra)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(shortcut)
        self.actionAmplitud_Profundidad.setText(QCoreApplication.translate("MainWindow", u"Busqueda en Amplitud/Profundidad", None))
#if QT_CONFIG(shortcut)
        self.actionAmplitud_Profundidad.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+B", None))
#endif // QT_CONFIG(shortcut)
        self.actionPrim.setText(QCoreApplication.translate("MainWindow", u"Prim", None))
#if QT_CONFIG(shortcut)
        self.actionPrim.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+P", None))
#endif // QT_CONFIG(shortcut)
        self.actionKruskal.setText(QCoreApplication.translate("MainWindow", u"Kruskal", None))
#if QT_CONFIG(shortcut)
        self.actionKruskal.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+K", None))
#endif // QT_CONFIG(shortcut)
        self.actionDijkstra.setText(QCoreApplication.translate("MainWindow", u"Dijkstra", None))
#if QT_CONFIG(shortcut)
        self.actionDijkstra.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+D", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Salida para los grafos:", None))
        ...
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"DESTINO X:", None))
