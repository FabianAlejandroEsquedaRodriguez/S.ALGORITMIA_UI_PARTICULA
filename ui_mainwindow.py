...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsView.setGeometry(QRect(195, 30, 401, 351))
        self.dibujar = QPushButton(self.tab_3)
        self.dibujar.setObjectName(u"dibujar")
        self.dibujar.setGeometry(QRect(10, 290, 171, 23))
        self.limpiar = QPushButton(self.tab_3)
        self.limpiar.setObjectName(u"limpiar")
        self.limpiar.setGeometry(QRect(10, 320, 171, 23))
        self.dibujar_grafo_pushButton = QPushButton(self.tab_3)
        self.dibujar_grafo_pushButton.setObjectName(u"dibujar_grafo_pushButton")
        self.dibujar_grafo_pushButton.setGeometry(QRect(10, 350, 171, 23))
        self.label_11 = QLabel(self.tab_3)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(10, 10, 47, 13))
        self.plainTextEdit = QPlainTextEdit(self.tab_3)
        self.plainTextEdit.setObjectName(u"plainTextEdit")
        self.plainTextEdit.setGeometry(QRect(10, 30, 171, 251))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dibujar_grafo_pushButton.setText(QCoreApplication.translate("MainWindow", u"Grafo", None))
